...
//                }
    ...
    public function servicebanners(Request $request) {

        $service_id = $request->service_id;

        if($serviceList = Banners::where('service_id',$service_id)->get()) {
    ...
    public function servicetips(Request $request) {

        $service_id = $request->service_id;

        if($serviceList = DB::table('service_safety')->where('service_id',$service_id)->get()) {
    ...
    public function banners() {
        ...
        if($serviceList = Banners::where('service_id',0)->get()) {
