            ...
            <div class="manage-doc-content">
                <div class="manage-doc-section pad50">
                    ...
                    <div class="manage-doc-section-content row">
                        <div class="prof-sub-col column">
                            <br/>
                            <div class="field">
                                <input tabindex="2" id="pac-input" class="input" type="text" placeholder="@lang('provider.enter_location')" name="s_address">
                            </div>
                        </div>
                        ...
                        <form action="{{ route('provider.location.update') }}" id="location_update_form" method="POST" class="form-horizontal row-border">
                            ...
                            <div class="prof-form-sub-sec border-top">
                                <div class="column column col-md-offset-3">
                                    <button type="submit" class="button is-block btn-primary update-link"> @lang('provider.profile.update')</button>
                                </div>
                            </div>
                        </form>
                    </div>
