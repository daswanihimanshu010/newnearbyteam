            ...
            <div class="container is-fluid">
                ...
                <div class="card">
                    ...
                    <footer class="card-footer">
                        @can('service-types-create')
                        <a href="{{ url('/').'/admin/servicebanner/'.$service->id }}"
                            class="card-footer-item"><i class="fa fa-sliders"></i> </a>
                        @endcan
                        @can('service-types-create')
                        <a href="{{ url('/').'/admin/servicesafety/'.$service->id }}"
                            class="card-footer-item"><i class="fa fa-pagelines"></i> </a>
                        @endcan
                        @can('service-types-create')
