...
Route::get('subservice/{id}', 'Resource\ServiceResource@subService');
...
Route::get('stripe', 'Resource\StripeController@index')->name('stripe');
Route::resource('stripe', 'Resource\StripeController');
...
//Banners
Route::resource('banner', 'Resource\BannerResource');
Route::get('servicebanner/{id}', 'Resource\BannerResource@service');
Route::get('servicebanner/create/{id}', 'Resource\BannerResource@servicecreate');

Route::get('servicesafety/{id}', 'Resource\ReasonResource@safety');
Route::get('servicesafetyinsert/{id}', 'Resource\ReasonResource@safetyinsert');
Route::post('servicesafetystore', 'Resource\ReasonResource@safetystore');
